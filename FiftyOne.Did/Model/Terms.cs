...
namespace FiftyOne.Did.Model
{
    ...
    /// https://github.com/51Degrees/specifications/blob/main/did-specification/identifier-layout.md#terms
    /// and this class is the only place in the shipped code that carries
    /// it. The tests write the address out again on purpose, so that a test
    /// never compares the reader with itself.
    /// <para>
