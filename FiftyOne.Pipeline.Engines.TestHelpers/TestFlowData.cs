...
{
    /// <summary>
    /// Helper class that is used when the base functionality of FlowData 
    /// is required to avoid overly complicated test setup.
    /// </summary>
    public class TestFlowData : FlowData
    {
        ...
        public TestFlowData(
            ...
            TestPipeline pipeline,
            Evidence evidence) :
            base(logger, pipeline == null ? null : pipeline.InternalPipeline, evidence)
        {
        }
    }
}
