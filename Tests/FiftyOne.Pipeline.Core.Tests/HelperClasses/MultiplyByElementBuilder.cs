...
{
    /// <summary>
    /// The builder to use when creating <see cref="MultiplyByElement"/>
    /// </summary>
    [AlternateName("Multiply")]
    public class MultiplyByElementBuilder
    {
        ...
        /// <returns></returns>
        public IFlowElement Build(int multiple)
        {
            return new MultiplyByElement(multiple);
        }
    }
}
