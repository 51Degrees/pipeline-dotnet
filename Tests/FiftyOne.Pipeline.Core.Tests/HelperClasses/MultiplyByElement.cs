...
{
    /// <summary>
    /// Test element that multiplies an evidence value by an amount defined 
    /// at build time.
    /// </summary>
    public class MultiplyByElement : FlowElementBase<TestElementData, IElementPropertyMetaData>
    {
        public override string ElementDataKey => "muliplyBy";
        ...
        public MultiplyByElement(int multiple) :
            base(new Mock<ILogger<MultiplyByFiveElement>>().Object)
        {
            _multiple = multiple;
