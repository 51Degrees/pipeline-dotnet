...
{
    [TestClass]
    public class TypedKeyMapTestConcurrent : TypedKeyMapTestBase
    {
        [TestInitialize]
        public void Init()
        {
            _map = new TypedKeyMap(true);
        }
        ...
        /// </summary>
        [TestMethod]
        public void TypedMap_Concurrent_AddRetrieve() { TypedMap_AddRetrieve(); }

        /// <summary>
        /// Add a complex value type to the map and retrieve it.
        /// </summary>
        [TestMethod]
        public void TypedMap_Concurrent_ComplexValueType() { TypedMap_ComplexValueType(); }

        /// <summary>
        /// Add a complex reference type to the map and retrieve it.
        /// </summary>
        [TestMethod]
        public void TypedMap_Concurrent_ComplexReferenceType() { TypedMap_ComplexReferenceType(); }
        ...
        /// </summary>
        [TestMethod]
        public void TypedMap_Concurrent_MultipleDataObjects() { TypedMap_MultipleDataObjects(); }
        ...
        /// </summary>
        [TestMethod]
        public void TypedMap_Concurrent_NullValue() { TypedMap_NullValue(); }

        /// <summary>
        /// Check that the Get&lt;T&gt;() method works as expected.
        /// </summary>
        [TestMethod]
        public void TypedMap_Concurrent_GetByType() { TypedMap_GetByType(); }
        ...
        /// </summary>
        [TestMethod]
        public void TypedMap_Concurrent_GetByTypeInterface() { TypedMap_GetByTypeInterface(); }

        // Test the TryGetValue method in various scenarios.
        // See base class for full comments on each method.
        [TestMethod]
        public void TypedMap_Concurrent_TryGetValue_GoodKey_String() { TypedMap_TryGetValue_GoodKey_String(); }
        [TestMethod]
        public void TypedMap_Concurrent_TryGetValue_BadKeyName_String() { TypedMap_TryGetValue_BadKeyName_String(); }
        [TestMethod]
        public void TypedMap_Concurrent_TryGetValue_BadKeyType_String() { TypedMap_TryGetValue_BadKeyType_String(); }
        [TestMethod]
        public void TypedMap_Concurrent_TryGetValue_GoodKey_ComplexType() { TypedMap_TryGetValue_GoodKey_ComplexType(); }
        [TestMethod]
        public void TypedMap_Concurrent_TryGetValue_GoodKeyInterface_ComplexType() { TypedMap_TryGetValue_GoodKeyInterface_ComplexType(); }
        [TestMethod]
        public void TypedMap_Concurrent_TryGetValue_BadKeyName_ComplexType() { TypedMap_TryGetValue_BadKeyName_ComplexType(); }
        [TestMethod]
        public void TypedMap_Concurrent_TryGetValue_BadKeyType_ComplexType() { TypedMap_TryGetValue_BadKeyType_ComplexType(); }
    }
}
