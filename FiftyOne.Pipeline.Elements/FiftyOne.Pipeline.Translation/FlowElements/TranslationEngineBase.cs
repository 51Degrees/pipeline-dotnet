...
[assembly: InternalsVisibleTo("FiftyOne.Pipeline.TranslationTests, PublicKey=")]
namespace FiftyOne.Pipeline.Translation.FlowElements
{
        ...
        where T : ITranslationData
    {
        ...
        /// </param>
        /// <param name="sources">
        /// Sources used to perform translations. YAML format strings keyed on
        /// file name.
        /// </param>
            ...
            MissingTranslationBehavior behavior)
        {
            ...
            {
                var language = GetLanguageName(source.Key);

                var translations = deserializer
                    .Deserialize<Dictionary<string, string>>(source.Value);

                if (translations == null)
                {
                    throw new InvalidDataException($"The source for " +
                        $"{source.Key} could not be parsed into a valid " +
                        $"translation lookup.");
                }
