...
namespace FiftyOne.Pipeline.DerivedProperty.Data
{
    /// <summary>
    /// Data populated by
    /// <see cref="FlowElements.DerivedPropertyElement"/>.
    /// </summary>
        ...
        IDerivedPropertyData
    {
        ...
        /// </summary>
        /// <param name="logger">The logger for the data instance.</param>
        /// <param name="pipeline">The pipeline the data belongs to.</param>
        public DerivedPropertyData(
            ILogger<DerivedPropertyData> logger,
            IPipeline pipeline)
        ...
        /// <param name="logger">The logger for the data instance.</param>
        /// <param name="pipeline">The pipeline the data belongs to.</param>
        /// <param name="dictionary">The values to start with.</param>
        public DerivedPropertyData(
